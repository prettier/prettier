...
- A `.prettierrc.js`, `.prettierrc.ts`, `prettier.config.js`, or `prettier.config.ts` file that exports an object using `export default` or `module.exports` (depends on the [`type`](https://nodejs.org/api/packages.html#type) value in your `package.json`).
- A `.prettierrc.mjs`, `.prettierrc.mts`, `prettier.config.mjs`, or `prettier.config.mts` file that exports an object using `export default`.
- A `.prettierrc.cjs`, `.prettierrc.cts`, `prettier.config.cjs`, or `prettier.config.cts` file that exports an object using `module.exports`.
...
```js
// prettier.config.js, prettier.config.ts, .prettierrc.js, .prettierrc.ts, prettier.config.mjs, prettier.config.mts, .prettierrc.mjs or .prettierrc.mts
...
```js
// prettier.config.js, prettier.config.ts, .prettierrc.js, .prettierrc.ts, prettier.config.cjs, prettier.config.cts, .prettierrc.cjs or .prettierrc.cts

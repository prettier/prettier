...
- **`plugins`**: Unlike the `format` function from the [Node.js-based API](api.md#prettierformatsource--options), this function doesn’t load plugins automatically. The `plugins` option is required because all the parsers included in the Prettier package come as plugins (for reasons of file size). These plugins are files named
  ...
  - `parser-*.js` in <https://unpkg.com/browse/prettier@2.8.2/> and
  - `parser-*.mjs` in <https://unpkg.com/browse/prettier@2.8.2/esm/>
...
<script src="https://unpkg.com/prettier@2.8.2/parser-graphql.js"></script>
<script>
...
```html
<script type="module">
  import prettier from "https://unpkg.com/prettier@2.8.2/esm/standalone.mjs";
  import parserGraphql from "https://unpkg.com/prettier@2.8.2/esm/parser-graphql.mjs";
...
define([
  ...
  "https://unpkg.com/prettier@2.8.2/parser-graphql.js",
], (prettier, ...plugins) => {
  prettier.format("type Query { hello: String }", {
    parser: "graphql",
    plugins,
...
importScripts("https://unpkg.com/prettier@2.8.2/parser-graphql.js");
prettier.format("type Query { hello: String }", {
  parser: "graphql",
  plugins: prettierPlugins,
});
...
<script type="module">
  import prettier from "https://unpkg.com/prettier@2.8.2/esm/standalone.mjs";
  import parserBabel from "https://unpkg.com/prettier@2.8.2/esm/parser-babel.mjs";
...
<script type="module">
  import prettier from "https://unpkg.com/prettier@2.8.2/esm/standalone.mjs";
  import parserBabel from "https://unpkg.com/prettier@2.8.2/esm/parser-babel.mjs";
  import parserHtml from "https://unpkg.com/prettier@2.8.2/esm/parser-html.mjs";

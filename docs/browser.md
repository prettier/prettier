...
<script src="https://unpkg.com/prettier@2.8.0/plugins/graphql.js"></script>
<script>
  (async () => {
...
```html
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@2.8.0/standalone.mjs";
  import pluginGraphql from "https://unpkg.com/prettier@2.8.0/plugins/graphql.mjs";
...
define([
  ...
  "https://unpkg.com/prettier@2.8.0/plugins/graphql.js",
...
importScripts("https://unpkg.com/prettier@2.8.0/plugins/graphql.js");
(async () => {
  const formatted = await prettier.format("type Query { hello: String }", {
    parser: "graphql",
    plugins: prettierPlugins,
...
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@2.8.0/standalone.mjs";
  import pluginBabel from "https://unpkg.com/prettier@2.8.0/plugins/babel.mjs";
...
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@2.8.0/standalone.mjs";
  import pluginBabel from "https://unpkg.com/prettier@2.8.0/plugins/babel.mjs";
  import pluginHtml from "https://unpkg.com/prettier@2.8.0/plugins/html.mjs";

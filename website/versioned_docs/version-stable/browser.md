...
- **`plugins`**: Unlike the `format` function from the [Node.js-based API](api.md#prettierformatsource-options), this function doesn’t load plugins automatically. The `plugins` option is required because all the parsers included in the Prettier package come as plugins (for reasons of file size). These plugins are files in [https://unpkg.com/browse/prettier@3.5.0-dev/plugins](https://unpkg.com/browse/prettier@3.5.0-dev/plugins). Note that `estree` plugin should be loaded when printing JavaScript, TypeScript, Flow, or JSON.
...
```html
<script src="https://unpkg.com/prettier@3.5.0-dev/standalone.js"></script>
<script src="https://unpkg.com/prettier@3.5.0-dev/plugins/graphql.js"></script>
<script>
  (async () => {
...
```html
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@3.5.0-dev/standalone.mjs";
  import prettierPluginGraphql from "https://unpkg.com/prettier@3.5.0-dev/plugins/graphql.mjs";
...
```js
define([
  "https://unpkg.com/prettier@3.5.0-dev/standalone.js",
  "https://unpkg.com/prettier@3.5.0-dev/plugins/graphql.js",
...
```js
importScripts("https://unpkg.com/prettier@3.5.0-dev/standalone.js");
importScripts("https://unpkg.com/prettier@3.5.0-dev/plugins/graphql.js");
...
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@3.5.0-dev/standalone.mjs";
  import prettierPluginBabel from "https://unpkg.com/prettier@3.5.0-dev/plugins/babel.mjs";
  import prettierPluginEstree from "https://unpkg.com/prettier@3.5.0-dev/plugins/estree.mjs";
...
<script type="module">
  ...
  import prettierPluginBabel from "https://unpkg.com/prettier@3.5.0-dev/plugins/babel.mjs";
  import prettierPluginEstree from "https://unpkg.com/prettier@3.5.0-dev/plugins/estree.mjs";
  import prettierPluginHtml from "https://unpkg.com/prettier@3.5.0-dev/plugins/html.mjs";

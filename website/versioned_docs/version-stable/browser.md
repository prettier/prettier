...
```html
<script src="https://unpkg.com/prettier@3.9.5/standalone.js"></script>
<script src="https://unpkg.com/prettier@3.9.5/plugins/graphql.js"></script>
<script>
  (async () => {
...
```html
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@3.9.5/standalone.mjs";
  import * as prettierPluginGraphql from "https://unpkg.com/prettier@3.9.5/plugins/graphql.mjs";
...
```js
define([
  "https://unpkg.com/prettier@3.9.5/standalone.js",
  "https://unpkg.com/prettier@3.9.5/plugins/graphql.js",
...
```js
import * as prettier from "https://unpkg.com/prettier@3.9.5/standalone.mjs";
import * as prettierPluginGraphql from "https://unpkg.com/prettier@3.9.51/plugins/graphql.mjs";
...
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@3.9.5/standalone.mjs";
  import * as prettierPluginBabel from "https://unpkg.com/prettier@3.9.5/plugins/babel.mjs";
  import * as prettierPluginEstree from "https://unpkg.com/prettier@3.9.5/plugins/estree.mjs";
...
<script type="module">
  ...
  import * as prettierPluginBabel from "https://unpkg.com/prettier@3.9.5/plugins/babel.mjs";
  import * as prettierPluginEstree from "https://unpkg.com/prettier@3.9.5/plugins/estree.mjs";
  import * as prettierPluginHtml from "https://unpkg.com/prettier@3.9.5/plugins/html.mjs";

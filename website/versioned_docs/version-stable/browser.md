...
```html
<script src="https://unpkg.com/prettier@2.5.0/standalone.js"></script>
<script src="https://unpkg.com/prettier@2.5.0/parser-graphql.js"></script>
<script>
...
```html
<script type="module">
  import prettier from "https://unpkg.com/prettier@2.5.0/esm/standalone.mjs";
  import parserGraphql from "https://unpkg.com/prettier@2.5.0/esm/parser-graphql.mjs";
...
```js
define([
  "https://unpkg.com/prettier@2.5.0/standalone.js",
  "https://unpkg.com/prettier@2.5.0/parser-graphql.js",
], (prettier, ...plugins) => {
  prettier.format("type Query { hello: String }", {
    parser: "graphql",
    plugins,
...
importScripts("https://unpkg.com/prettier@2.5.0/parser-graphql.js");
prettier.format("type Query { hello: String }", {
  parser: "graphql",
  plugins: prettierPlugins,
});
...
<script type="module">
  import prettier from "https://unpkg.com/prettier@2.5.0/esm/standalone.mjs";
  import parserBabel from "https://unpkg.com/prettier@2.5.0/esm/parser-babel.mjs";
...
<script type="module">
  import prettier from "https://unpkg.com/prettier@2.5.0/esm/standalone.mjs";
  import parserBabel from "https://unpkg.com/prettier@2.5.0/esm/parser-babel.mjs";
  import parserHtml from "https://unpkg.com/prettier@2.5.0/esm/parser-html.mjs";

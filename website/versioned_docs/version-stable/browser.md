...
- **`plugins`**: Unlike the `format` function from the [Node.js-based API](api.md#prettierformatsource-options), this function doesn’t load plugins automatically. The `plugins` option is required because all the parsers included in the Prettier package come as plugins (for reasons of file size). These plugins are files in [https://unpkg.com/browse/prettier@3.8.4/plugins](https://unpkg.com/browse/prettier@3.8.4/plugins). Note that `estree` plugin should be loaded when printing JavaScript, TypeScript, Flow, or JSON.
...
```html
<script src="https://unpkg.com/prettier@3.8.4/standalone.js"></script>
<script src="https://unpkg.com/prettier@3.8.4/plugins/graphql.js"></script>
<script>
  (async () => {
...
```html
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@3.8.4/standalone.mjs";
  import * as prettierPluginGraphql from "https://unpkg.com/prettier@3.8.4/plugins/graphql.mjs";
...
```js
define([
  "https://unpkg.com/prettier@3.8.4/standalone.js",
  "https://unpkg.com/prettier@3.8.4/plugins/graphql.js",
...
```js
import * as prettier from "https://unpkg.com/prettier@3.8.4/standalone.mjs";
import * as prettierPluginGraphql from "https://unpkg.com/prettier@3.8.41/plugins/graphql.mjs";
...
<script type="module">
  import * as prettier from "https://unpkg.com/prettier@3.8.4/standalone.mjs";
  import * as prettierPluginBabel from "https://unpkg.com/prettier@3.8.4/plugins/babel.mjs";
  import * as prettierPluginEstree from "https://unpkg.com/prettier@3.8.4/plugins/estree.mjs";
...
<script type="module">
  ...
  import * as prettierPluginBabel from "https://unpkg.com/prettier@3.8.4/plugins/babel.mjs";
  import * as prettierPluginEstree from "https://unpkg.com/prettier@3.8.4/plugins/estree.mjs";
  import * as prettierPluginHtml from "https://unpkg.com/prettier@3.8.4/plugins/html.mjs";

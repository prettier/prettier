...
```bash
npm install --save-dev --save-exact prettier@3.9.4
```
...
```bash
yarn add --dev --exact prettier@3.9.4
```
...
```bash
pnpm add --save-dev --save-exact prettier@3.9.4
```
...
```bash
bun add --dev --exact prettier@3.9.4
```
...
```bash
deno install --dev --save-exact prettier@3.9.4
```

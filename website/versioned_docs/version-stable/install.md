...
```bash
npm install --save-dev --save-exact prettier@3.9.7
```
...
```bash
yarn add --dev --exact prettier@3.9.7
```
...
```bash
pnpm add --save-dev --save-exact prettier@3.9.7
```
...
```bash
bun add --dev --exact prettier@3.9.7
```
...
```bash
deno install --dev --save-exact prettier@3.9.7
```

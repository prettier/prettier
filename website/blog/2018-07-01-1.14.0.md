...
This release adds YAML support, several new syntax features, formatting fixes, pragma support for every language, and improves performance on big files.
...
The implementation is highly compliant with the [YAML spec](http://yaml.org/spec/), and backed by the excellent [`yaml`](https://github.com/eemeli/yaml) package thanks to [@eemeli].

**Word wrap**

The ability to wrap code is the core feature of Prettier, this also applies to YAML.
...
[Pragma](https://prettier.io/docs/en/options.html#require-pragma) is also supported in YAML:
...
For some reason you don't want to format part of the YAML file you could put an ignore comment in front of it:
...
It's also able to format front matters in css and markdown files:

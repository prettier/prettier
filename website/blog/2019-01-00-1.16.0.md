...
prettier.format("foo-code", { plugins: [fooPlugin], parser: "foo-parser" });
// Output (Prettier 1.15): Error: Path must be a string.
// Output (Prettier 1.16): No error
```
...
[html-comment-template]: https://prettier.io/blog/2018/11/07/1.15.0.html#html-template-literal-in-javascript

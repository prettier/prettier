...
If you use [`@prettier/plugin-oxc`](https://www.npmjs.com/package/@prettier/plugin-oxc) or [`@prettier/plugin-hermes`](https://www.npmjs.com/package/@prettier/plugin-hermes), don't forget to upgrade them to ensure the new formatting rules are applied.
...
#### Improve formatting of long mapped types across multiple lines ([#18779](https://github.com/prettier/prettier/pull/18779) by [@kovsu](https://github.com/kovsu)) {#change-18779}

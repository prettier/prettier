...
#### Add `cursorOffset` option for cursor translation (#1637) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Add `--range-start/end` options to format only parts of the input (#1609) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Adding filepath option in order to enable filetype inference (#1835) by [@mitermayer](https://github.com/mitermayer)
...
#### Wrap text content inside of JSX (#1120, #1671, #1827, #1829) by [@karl](https://github.com/karl)
...
#### Remove parenthesis for JSX inside of arrow functions (#1733) by [@xixixao](https://github.com/xixixao)
...
#### Improve template literal printing (#1664, #1714) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Fix empty line with flow union (#1511) by [@existentialism](https://github.com/existentialism)
...
#### Unescape unnecessarily escaped characters in strings (#1575) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Fix boolean for empty objects (#1590) by [@dmitrika](https://github.com/dmitrika)
...
#### Remove Parens from SequenceExpressions in ForStatements (#1597) by [@k15a](https://github.com/k15a)
...
#### Preserve unusual unicode whitespace (#1658, #1165) by [@karl](https://github.com/karl) and [@yamafaktory](https://github.com/yamafaktory)
...
#### Don't let trailing template literal comments escape (#1580, #1713, #1598, #1713) by [@josephfrazier](https://github.com/josephfrazier) and [@k15a](https://github.com/k15a)
...
#### Parenthesize await correctly (#1513, #1595, #1593) by [@bakkot](https://github.com/bakkot) and [@existentialism](https://github.com/existentialism)
...
#### Preserve getter/setter info on flow ObjectTypeProperty (#1585) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Fall back to non-strict mode in babylon (#1587, #1608) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Ignore node_modules when running prettier from CLI (#1683) by [@thymikee](https://github.com/thymikee)
...
#### Traverse dot files for glob (#1844) by [@jhgg](https://github.com/jhgg)

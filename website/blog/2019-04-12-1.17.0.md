...
This release brings long requested flexibility for object's property quotes, support for shared configurations, a LWC parser, new GraphQL syntax and other fixes.
...
#### Respect newlines between parameters ([#5260] by [@evilebottnawi])
...
Prettier now supports automatically loading scoped plugins named `@scope_name/prettier-plugin-*`.
...
[#5260]: https://github.com/prettier/prettier/pull/5260

---
author: Christopher Chedeau ([@vjeux](https://github.com/vjeux))
...
#### Implement cosmiconfig for workspace configuration (#2434) by [@azz](https://github.com/azz)
...
#### Support .prettierignore files (#2412) by [@evilebottnawi](https://github.com/evilebottnawi)
...
#### Improve JSX Formatting (#2398) by [@suchipi](https://github.com/suchipi)
...
#### Inline single expressions in JSX (#2442) by [@karl](https://github.com/karl)
...
#### Ensure there is a line break after leading JSX white space (#2348) by [@karl](https://github.com/karl)
...
#### Use babylon.parseExpression for JSON (#2476) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Print 3 or more chained calls on multiple lines (#2673) by [@azz](https://github.com/azz)
...
#### Add more supervisory parens (#2423) by [@azz](https://github.com/azz)
...
#### Implement prettier-ignore inside JSX (#2487) by [@azz](https://github.com/azz)
...
#### Fix indentation of a do-while condition (#2359) by [@jsnajdr](https://github.com/jsnajdr)
...
#### Break sequence expressions (#2388) by [@bakkot](https://github.com/bakkot)
...
#### Trim trailing whitespace from comments (#2494) by [@azz](https://github.com/azz)
...
#### Improve bind expression formatting (#2493) by [@azz](https://github.com/azz)
...
#### Add support for printing optional catch binding (#2570) by [@existentialism](https://github.com/existentialism)
...
#### Add support for printing optional chaining syntax (#2572) by [@azz](https://github.com/azz)
...
#### Handle Closure Compiler type cast syntax correctly (#2484) by [@yangsu](https://github.com/yangsu)
...
#### Inline first computed property lookup in member chain (#2670) by [@azz](https://github.com/azz)
...
#### Support opaque types and export star (#2543, #2542) by [@existentialism](https://github.com/existentialism)
...
#### Strip away unnecessary quotes in keys in type objects and interfaces (#2643) by [@jackyho112](https://github.com/jackyho112)
...
#### Print TypeParameter even when unary function type (#2406) by [@danwang](https://github.com/danwang)
...
#### Keep parens around FunctionTypeAnnotation inside ArrayTypeAnnotation (#2561) by [@azz](https://github.com/azz)
...
#### Support TypeScript 2.5 RC (#2672) by [@azz](https://github.com/azz)
...
#### Don't add namespace keyword to global declaration (#2329) by [@azz](https://github.com/azz)
...
#### Fix <this.Component /> (#2472) by [@backus](https://github.com/backus)
...
#### Allow type assertions to hug (#2439) by [@azz](https://github.com/azz)
...
#### Remove parens for type assertions in binary expressions (#2419) by [@azz](https://github.com/azz)
...
#### Print parens around type assertion as LHS in assignment (#2525) by [@azz](https://github.com/azz)
...
#### Print declare for TSInterfaceDeclaration (#2574) by [@existentialism](https://github.com/existentialism)
...
#### Normalize quotes in CSS (#2624) by [@lydell](https://github.com/lydell)
...
#### Normalize numbers in CSS (#2627) by [@lydell](https://github.com/lydell)
...
#### Quote unquoted CSS attribute values in selectors (#2644) by [@lydell](https://github.com/lydell)
...
#### Add support for css keyword (#2337) by [@zanza00](https://github.com/zanza00)
...
#### Support styled-components with existing component (#2552, #2619) by [@azz](https://github.com/azz)
...
#### Trim whitespace in descendant combinator (#2411) by [@azz](https://github.com/azz)
...
#### Strip BOM before parsing (#2373) by [@azz](https://github.com/azz)
...
#### Add support for range-formatting GraphQL (#2319) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Add `.gql` file extension to be parsed as GraphQL (#2357) by [@rrdelaney](https://github.com/rrdelaney)
...
#### Support multiple patterns with ignore pattern (#2356) by [@evilebottnawi](https://github.com/evilebottnawi)
...
#### Make --list-different to work with --stdin (#2393) by [@josephfrazier](https://github.com/josephfrazier)

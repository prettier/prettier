...
#### Option to add parens in arrow function arguments (#3324) by [@rattrayalex](https://github.com/rattrayalex) and [@suchipi](https://github.com/suchipi)
...
#### JSX fragment syntax (#3237) by [@duailibe](https://github.com/duailibe)
...
#### Fix slow formatting long texts in JSX (#3268, #3273) by [@duailibe](https://github.com/duailibe)
...
#### Add an option to preserve text line breaks (#3340) by [@ikatyang](https://github.com/ikatyang)
...
#### Support top-level interpolations (#3370) by [@lydell](https://github.com/lydell)
...
#### Preserve intentional new lines in GraphQL (#3252) by [@duailibe](https://github.com/duailibe)
...
#### Don't lowercase element names and attribute names in selectors (#3317) by [@lydell](https://github.com/lydell)
...
#### Add EditorConfig support (#3255) by [@josephfrazier](https://github.com/josephfrazier)
...
#### Don't break simple elements in JSX (#3250) by [@duailibe](https://github.com/duailibe)

Prettier won't break an element with no attributes anymore, keeping elements like `<br />` as an unit.

#### Don't break identifiers inside template literals expressions (#3299) by [@duailibe](https://github.com/duailibe)
...
#### Fix formatting of comment inside arrow function (#3334) by [@jackyho112](https://github.com/jackyho112)
...
#### Fix printing of comments around decorators and class properties (#3382) by [@azz](https://github.com/azz)
...
#### Do not break on empty type parameters (#3281) by [@Vjeux](https://github.com/Vjeux)

It won't break empty type parameters (`foo: Type<>`) anymore.

#### Add support for flow mixins when using babylon (#3391) by [@bakkot](https://github.com/bakkot)
...
#### Don't print a trailing comma after object rest spread (#3313) by [@duailibe](https://github.com/duailibe)
...
#### Print parens around type assertions for decorators (#3329) by [@azz](https://github.com/azz)
...
#### Don't break `inlineCode` (#3230) by [@ikatyang](https://github.com/ikatyang)

Prettier won't break text inside `inlineCode` meaning it will only break of after it.

#### No extra whitespace between non-CJK and CJK-punctuation and vice-versa (#3244, #3249) by [@ikatyang](https://github.com/ikatyang)
...
#### Escape all emphasis-like text (#3246) by [@ikatyang](https://github.com/ikatyang)

Fixes the case where `\_\_text\_\_` would be formatted as `__text__`.

#### Handle punctuation variants (#3254) by [@ikatyang](https://github.com/ikatyang)

Prettier now considers not only ASCII punctuation characters but Unicode as well.

#### Support TOML front matter (#3290) by [@ikatyang](https://github.com/ikatyang)
...
#### Only indent the first non-list node in checkbox list item (#3297) by [@ikatyang](https://github.com/ikatyang)
...
#### Preserve non-breaking whitespaces (#3327) by [@ikatyang](https://github.com/ikatyang)
...
#### Do not break before special prefix (#3347) by [@ikatyang](https://github.com/ikatyang)
...
#### Omit semicolon in simple JSX expressions (#3330) by [@sapegin](https://github.com/sapegin)

...
#### Support markdown (#2943) by [@ikatyang](https://github.com/ikatyang)
...
#### Add option to insert `@format` to first docblock if absent (#2865) by [@samouri](https://github.com/samouri)
...
#### Add `--loglevel` option (#2992) by [@ikatyang](https://github.com/ikatyang)
...
#### Fix indentation for JSDoc comments (#2470) by [@maxdeviant](https://github.com/maxdeviant)
...
#### Print pipeline and nullish-coalescing operators (#3036) by [@azz](https://github.com/azz)
...
#### Improved template literal expresions line breaks (#3124) by [@duailibe](https://github.com/duailibe)
...
#### Don't inline trailing `}` for arrow functions attributes (#3110) by [@duailibe](https://github.com/duailibe)
...
#### Make the factory detection handle multiple elements (#3112) by [@vjeux](https://github.com/vjeux)
...
#### Handle comments between function name and open paren (#2979) by [@azz](https://github.com/azz)
...
#### Support sequential CallExpressions in member chains (#2990) by [@chrisvoll](https://github.com/chrisvoll)
...
#### Account for empty lines in long member call chain (#3035) by [@jackyho112](https://github.com/jackyho112)
...
#### Fix issue where first argument is left behind when line breaks (#3079) by [@mutdmour](https://github.com/mutdmour)
...
#### Break parens for binaries in member expression (#2958) by [@duailibe](https://github.com/duailibe)
...
#### Prevent breaking MemberExpression inside NewExpression (#3075) by [@duailibe](https://github.com/duailibe)
...
#### Fix array acessors in method chains (#3137) by [@duailibe](https://github.com/duailibe)
...
#### Fix indentation of intersection object types (#3074) by [@duailibe](https://github.com/duailibe)
...
#### Keep parens around TSAsExpression in ConditionalExpression (#3053) by [@azz](https://github.com/azz)
...
#### Collapse multiple JSX whitespaces (#2973) by [@karl](https://github.com/karl)
...
#### Don't print JSX bracket on same line when it has trailing comments (#3088) by [@azz](https://github.com/azz)
...
#### Preserve line breaks in grid declarations (#3133) by [@duailibe](https://github.com/duailibe)
...
#### Format SCSS maps like CSS rules (#3070) by [@asmockler](https://github.com/asmockler)
...
#### Fix formatting styled(Foo).attrs(...)`` (#3073) by [@existentialism](https://github.com/existentialism)
...
#### Prevent formatting GraphQL template literals with expressions (#2975) by [@duailibe](https://github.com/duailibe)
...
#### Don't use ANSI codes if stdout isn't a TTY (#2903) by [@Narigo](https://github.com/Narigo)
...
#### Use relative paths with CLI (#2969) by [@ahmedelgabri](https://github.com/ahmedelgabri)
...
#### Resolve file paths relative to config file (#3037) by [@azz](https://github.com/azz)
...
#### Respect CJK width and Combined Characters (#3003, #3015) by [@ikatyang](https://github.com/ikatyang)
...
#### Implement getSupportInfo() and use it for inference (#3033) by [@azz](https://github.com/azz)
...
#### Split source elements relative to their language. (#3069) by [@CiGit](https://github.com/CiGit)

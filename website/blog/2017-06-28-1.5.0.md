...
#### CSS: Every selector is now printed in its own line (#2047) by [@yuchi](https://github.com/yuchi)
...
#### CSS: lowercase hex colors (#2203) by [@azz](https://github.com/azz)
...
#### CSS: Print @else on same line as } (#2088) by [@azz](https://github.com/azz)
...
#### CSS: implement prettier-ignore (#2089) by [@azz](https://github.com/azz)
...
#### CSS: Fix css-modules composes breaking with long line width (#2190) by [@tdeekens](https://github.com/tdeekens)
...
#### CSS: First try scss when there's an [@import](https://github.com/import) with comma (#2225)
...
#### TypeScript: print arrow function type params on same line as params (#2101) by [@azz](https://github.com/azz)
...
#### TypeScript: keep parens around with yield/await non-null assertion (#2149) by [@azz](https://github.com/azz)
...
#### TypeScript: Print {} in import if it's in the source (#2150) by [@azz](https://github.com/azz)
...
#### TypeScript: Always break interfaces onto multiple lines (#2161) by [@azz](https://github.com/azz)
...
#### TypeScript: Fix extra semicolon in ambient typescript declaration emit (#2167) by [@azz](https://github.com/azz)
...
#### TypeScript: group function params in call/construct signatures (#2169) by [@azz](https://github.com/azz)
...
#### TypeScript: Upgrade tsep (#2183) by [@azz](https://github.com/azz)
...
#### TypeScript: break on multiple interface extends (#2085) by [@azz](https://github.com/azz)
...
#### TypeScript: handle ObjectPattern instead of ObjectExpression inside BinaryExpression (#2238) by [@azz](https://github.com/azz)
...
#### Allow JSX lines to be recombined (#1831) by [@karl](https://github.com/karl)
...
#### Break on non-literal computed member expression (#2087) by [@azz](https://github.com/azz)
...
#### Indent first variable in one-var scenario (#2095) by [@azz](https://github.com/azz)
...
#### Allow break with both default named import (#2096) by [@azz](https://github.com/azz)
...
#### Turn allowImportExportEverywhere on (#2207) by [@zimme](https://github.com/zimme)
...
#### Various fixes for range and cursor tracking (#2266, #2248, #2250, #2136) by [@CiGit](https://github.com/CiGit) and [@josephfrazier](https://github.com/josephfrazier)

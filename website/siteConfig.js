...
const siteConfig = {
  ...
  headerLinksInternal: [
    ...
    {section: 'api', href: '/prettier/docs/LANGUAGE/why-prettier.html', text: 'API'},
    {section: 'help', href: '/prettier/LANGUAGE/help.html', text: 'Help'},
    // {section: 'blog', href: '/test-site/blog', text: 'Blog'},
    {section: 'playground', href: '/prettier/playground.html', text: 'Playground'}
  ],
  ...
  colors: {
    ...
    prismColor: 'rgba(38, 38, 38, 0.03)', /* primaryColor in rgba form, with 0.03 alpha */
  },
};

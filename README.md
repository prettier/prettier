...
| **Quotes** - Use single quotes instead of double quotes.<br /><br />Notes:<br /> - Quotes in JSX will always be double and ignore this setting. <br /> - If a string contains a (escaped) single quote, double quotes will be used - Example: `"This won't be single quoted"` <br />  | `false` | `--single-quote` | `singleQuote: <bool>` |

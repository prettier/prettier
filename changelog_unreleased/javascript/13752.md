...
The Stage 2 proposal ["Explicit Resource Management"](https://github.com/tc39/proposal-explicit-resource-management/) is now supported via Babel 7.20.0. Also keep in mind our [policy on non-standardized syntax](https://github.com/tc39/proposal-explicit-resource-management/) before using this proposed syntax feature with Prettier.

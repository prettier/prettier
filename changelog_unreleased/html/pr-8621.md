...
><param name="autoplay" value="true"></object><meter min="0" max="1" low=".4" high=".7" optimum=".5" value=".2"></meter><progress value=".5" max="1"></progress>
...
><object data="horse.wav"
  ><param name="autoplay" value="true" /><param
    name="autoplay"    value="true" /></object

...
This behavior was changed in [#472](https://github.com/prettier/prettier/pull/472), which allowed to preserve line endings preferred on Windows (`\r\n`, also known as `CRLF`).

[Since Prettier version 1.15](https://prettier.io/blog/2018/11/07/1.15.0.html#add-an-option-to-enforce-line-endings-5327-by-kachkaev), the flavor of line endings is configurable.
...
However, line endings in neighboring files could remain inconsistent.
...
You are encouraged to use the new default value.
It may be also worth [checking the option docs](https://prettier.io/docs/en/options.html#end-of-line) to ensure your git repo is configured correctly.

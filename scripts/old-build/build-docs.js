...
// --- Docs ---
  ...
  shell.exec(
    `node_modules/@babel/cli/bin/babel.js ${docs}/index.js --out-file ${docs}/index.js --presets=@babel/es2015`
  );
  ...
  shell.exec(
    `node_modules/@babel/cli/bin/babel.js ${docs}/parser-babylon.js --out-file ${docs}/parser-babylon.js --presets=@babel/es2015`
  );

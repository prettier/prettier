...
Available options:
  ...
  --config-precedence <cli-override|file-override|prefer-file>
                           Defines how config should be evaluated in combination of CLI arguments
                           cli-override  | default config => config file => CLI overrides
                           file-override | default config => CLI overrides => config file
                           prefer-file   | default config => config file (if file config is found) or
                                           default config => CLI overrides (if no file config is found)

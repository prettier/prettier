...
// Value of abstract property is removed since `@typescript-eslint/typescript-estree` v5
...
function throwErrorForInvalidAbstractProperty(tsNode, esTreeNode) {
  const SYNTAX_KIND_PROPERTY_DEFINITION = 165;
...
function postprocess(ast, options) {
  if (
    ...
    (options.originalText.includes("@") ||
      options.originalText.includes("abstract"))
  ) {

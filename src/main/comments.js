...
function printComments(path, print, options, needsSemi, shouldReturnParts = false) {
  ...
  const leadingParts = [];
  const trailingParts = shouldReturnParts ? [...printed] : [needsSemi ? ";" : "", printed];
  ...
  return shouldReturnParts ? parts : prependCursorPlaceholder(
    path,
    options,
    concat(parts),
  );

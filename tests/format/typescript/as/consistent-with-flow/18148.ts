...
// 79 width until `as` or `satisfies` keyword
const firstItem2 = ______________.items.find((item) => item.type === 'item') as T;
// 80 width until `as` or `satisfies` keyword
const firstItem_2 = ______________.items.find((item) => item.type === 'item') as T;

// 79 width until `as` or `satisfies` keyword
const firstItem3 = _____________.find((item) => item.type === 'item') satisfies T;
// 80 width until `as` or `satisfies` keyword
const firstItem_3 = _____________.find((item) => item.type === 'item') satisfies T;
